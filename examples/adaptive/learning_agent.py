        ...
        failure_log.append(
            {
                ...
                "attempt": attempt,
                "type": "infrastructure",
                "reason": "Transient connection error",
            }
        )
        ...
        failure_log.append(
            {
                ...
                "attempt": attempt,
                "type": "strategy",
                "reason": "Regression on insufficient data points",
            }
        )
        return (
            "Error: Regression analysis requires at least 30 data points. Only 4 values provided."
        )
        ...
        failure_log.append(
            {
                ...
                "attempt": attempt,
                "type": "strategy",
                "reason": "Executive template requires forecast data",
            }
        )
...
async def get_failure_log() -> str:
    ...
    lines = [
        f"  [{f['type'].upper()}] {f['tool']} (attempt {f['attempt']}): {f['reason']}"
        ...
        for attempt in range(1, 5):
            ...
            agent = await build_agent(
                ...
                instructions=(
                    ...
                    "Check the failure log before choosing parameters." + failure_context
                ),
            ...
            failures_this_attempt = len(
                [f for f in failure_log if f["attempt"] >= call_counter.get("search", 0) - 2]
            )
